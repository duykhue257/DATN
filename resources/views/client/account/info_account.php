...
<section class="shop spad" style="padding-top: 35px;">
        <div class="container">
            ...
            <h3 class="pb-4" style="font-weight: 500; font-size: 25px">Tài khoản của bạn</h3>
            <div class="row px-4">
                <!-- sidebar -->
                ...
                <div class="pt-4">
                    ...
                    <div>
                        <div class="row">
                            ...
                            <div>
                            <div class="d-flex"><p class="mr-2">Email: </p> <p style="font-weight: 500;">admin@gmail.com</p></div>                           
                            <div class="d-flex"><p class="mr-2">Số điện thoại: </p> <p style="font-weight: 500;">0123456789</p></div>
                            </div>

                            <div class="mb-4"><div class="form-check">
                            ...
                            <form class="d-none" id="myForm">
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">Mật khẩu mới<span style="color: red;"> *</span></label>
                                    <input type="password" class="form-control" id="exampleInputPassword1">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">Nhập lại mật khẩu mới<span style="color: red;"> *</span></label>
                                    <input type="password" class="form-control" id="exampleInputPassword1">
                                </div>
                            ...
                            <form class="row g-3">
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <input type="text" class="form-control" id="inputEmail" placeholder="admin@gmail.com">
                                </div>
                                <div class="col-12 mb-4">
