                                    ...
                                    @foreach ($categories as $ct)
                                        <div class="card">
                                            <div class="card-heading">
                                                <label for="{{ $ct->id }}">
                                                    <a href="#" class="category-filter" data-id="{{ $ct->id }}">
                                                        {{ $ct->name_cate }}
                                                    </a>
                                                </label>
                                            </div>
                        ...
                        <div class="sidebar__filter">
                            ...
                            <div class="filter-range-wrap">
                                <div id="price-range-slider"
                                    ...
                                    data-min="{{ $price_range['min_price'] }}" data-max="{{ $price_range['max_price'] }}">
                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if (currentCategoryFilter) {
                $('.category-filter[data-id="' + currentCategoryFilter + '"]').addClass('active');
            }
            ...
            $('.color-filter, .size-filter').change(function() {
                filterProducts();
            });
            ...
            function filterProducts() {
                var selectedCategory = $('.category-filter.active').data('id');
                var selectedColors = [];
                var selectedSizes = [];
                var selectedSort = $('#sortBySelect').val();
