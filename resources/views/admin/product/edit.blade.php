                        ...
                        <form class="max-w-md mx-auto" action="{{ route('product.update', $product->id) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="file" name="image" id="image" class="form-control file-input" placeholder=""
                                        aria-describedby="inputGroupFileAddon" onchange="previewImage(event)">
                                </div>
                                <br>
                                <img id="preview"  style="max-width:100px" src="{{ $product->image ? Storage::url($product->image) : '' }}" alt="">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <select id="category_id" name="category_id" class="form-select">
                                        <option value="{{ $product->category_id }}">{{ $product->name_cate }}</option>
